                            ...
                            {locale === 'us' ? (
                                <>
                                    <>
                                        ...
                                        <h5 className="mb-0"><strong>Rehearsal Dinner</strong></h5>
                                        <h6 className="mb-5" style={{fontSize: '12px', color: '#787878', }}><strong>When:</strong> 6:30pm - Flying Caballos Ranch <br/><strong>Where:</strong> 1150 Farmhouse Ln, San Luis Obispo</h6>
                                        <p className="text-align-center" style={{fontSize: '12px', color: '#787878', }}><strong>Who:</strong> Exclusively for the Bridal Party (Bridesmaids & Groomsmen) and close family members</p>
                                    </>
                                </>
                            ) : locale === 'at' ? (
                                <>
                                    <>
                                        ...
                                        <p className="text-align-center" style={{fontSize: '12px', color: '#787878', }}><strong>Who:</strong> Exclusively for the Bridal Party (Bridesmaids & Groomsmen), for those who travel from far and close family members</p>
                                    </>
                                </>
                            ) : null}
                        </div>
                                ...
                                <>
                                    <>
                                        ...
                                        <h6 className="mb-5 text-white" style={{fontSize: '12px', color: '#ffffff' }}>
                                            <strong>When: </strong> 4:00PM - Flying Caballos Ranch <br/>
                                            <strong>Where: </strong>1150 Farmhouse Ln, San Luis Obispo<br/>
                                        </h6>
                                        <p className="text-align-center" style={{fontSize: '12px', color: '#ffffff' }}>
                                            <strong>2:45pm</strong> - 1st Shuttle from La Cuesta Inn<br/>
                                            <strong>3:15pm</strong> - 2nd Shuttle from La Cuesta Inn<br/>
                                            <strong>3:45pm </strong> - Please be seated promptly
                                        </p>
                                    </>
                                    <br/>
                                    <>
                                        ...
                                        <h6 className="mb-5 text-white" style={{fontSize: '12px', color: '#ffffff' }}>
                                            <strong>When: </strong> 3:30PM - Flying Caballos Ranch <br/>
                                            <strong>Where: </strong>1150 Farmhouse Ln, San Luis Obispo<br/>
                                        </h6>
                                        <p className="text-align-center" style={{fontSize: '12px', color: '#ffffff' }}>
                                            <strong>4:30pm</strong> - Cocktail Hour & Appetizers <br/>
                                            <strong>6:00pm</strong> - Dinner<br/>
                                            <strong>7:30pm</strong> - Speeches & Pie<br/>
                                            <strong>8:00pm </strong> - Party <br/>
                                            <strong>10:00pm</strong> - Fireside S'mores
                                        </p>
                                    </>
                                </>
                            ) : locale === 'at' ? (
