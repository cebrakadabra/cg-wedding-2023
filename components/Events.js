                        ...
                        <div className="card card-body justify-content-between">
                            <div className="icon-round mb-5 mb-md-5  bg-icon-primary">
                                <svg className="icon-svg" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                     ...
                                     viewBox="0 0 156.016 144" enableBackground="new 0 0 156.016 144"
                                     xmlSpace="preserve">
                                    <g>
                                        <g>
                                            <g>
                            ...
                            <h5 className="mb-0">Main Ceremony</h5>
                            <h6 className="mb-5">16:00h - 17:00</h6>
                            <p className="text-align-center">Hôtel Monaco
                    ...
                    <div className="col-md-6 col-lg-4 d-flex ">
                        <div className="card card-body justify-content-between bg-primary text-light">
                            <div className="icon-round mb-3 mb-md-5  bg-icon-white">
                                <svg className="icon-svg" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                     viewBox="0 0 512 460" enableBackground="new 0 0 512 460;"
                                     xmlSpace="preserve">
                                    <g>
                                        <g>
                            ...
                            <h6 className="mb-5 text-white">17:00h - 19:00</h6>
                            <p className="text-align-center">Villa Nikko
                                <br/>501 Route de Geary
                                <br/>San Franciscio
                                <br/>(415) 292 - 0100
                            </p>
